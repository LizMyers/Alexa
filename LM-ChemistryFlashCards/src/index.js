...
var CARD_TEXT = "Learn the elements of the periodic table.";
var currentQuestionText = "";

function getWelcomeResponse(callback) {
    var sessionAttributes = {},
         speechOutput = "Hi there, I will ask you  " + GAME_LENGTH.toString()
...
function handleAnswerRequest(intent, session, callback) {
    ...
    if (!gameInProgress) {
        ...
        var speechOutput = "Sorry, that answer is not a  chemical element " + speechOutput;
       ...
       // if (answerSlotValid && intent.slots.Answer.value.toUpperCase() == correctAnswerText.toUpperCase()) {
            ...
            switch (currentScore) {
                ...
                break;
                case 3: speechOutputAnalysis = "Nice. "
                break;
        ...
        if (currentQuestionIndex == GAME_LENGTH - 1) {
            ...
            switch (currentScore) {
                case 5: 
                    ...
                    + GAME_LENGTH.toString() + " questions correct. Thanks for playing! ";
                    break;
                case 4:
                    speechOutput += speechOutputAnalysis + "You got " + currentScore.toString() + " out of "
                    + GAME_LENGTH.toString() + " questions correct. Thanks for playing! ";
                ...
                case 1:
                    speechOutput += speechOutputAnalysis + "You got " + currentScore.toString() + " out of "
                    + GAME_LENGTH.toString() + " questions correct. Review the elements of the periodic table and try again.";
                    break;
                case 0:
                     speechOutput += speechOutputAnalysis + "Oh dear . You got " + currentScore.toString() + " out of "
                    + GAME_LENGTH.toString() + " questions correct. Study the elements in the periodic table and try again.";
                    break;
            }
...
function handleGetHelpRequest(intent, session, callback) {
    ...
    session.attributes.userPromptedToContinue = true;
     ...
     var speechOutput = "To start a new game at any time, say, start new game. "
        ...
        repromptText = "Try to give the right answer. "
        + "Would you like to keep playing?";
